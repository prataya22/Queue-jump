  ...
  return (
    ...
    >
      ...
      <div className="karma-content">
        ...
        {karma.recentActivity &&
          karma.recentActivity.some((item) => item.status === "pending") && (
                    ...
                    >
                      ...
                      <motion.div
                        style={{
                          ...
                          inset: 0,
                          background:
                            "radial-gradient(circle, rgba(255, 184, 0, 0.15), transparent)",
                          borderRadius: "12px",
                        }}
                ...
                >
                  ...
                  >
                    <span
                      ...
                      style={{
                        fontWeight: "600",
                        color: item.points < 0 ? "#FF2D55" : "#00FF88",
                        whiteSpace: "nowrap",
                      }}
                    >
